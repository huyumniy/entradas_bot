    ...
    while True:
        try:
            ...
            while True: 
                ...
                stop_execution = ticketBotSettings['stopExecutionFlag']
                
                numero_mad = None
                con_mad = None
                if not stop_execution: stop_execution = driver.execute_script("return window.stopExecutionFlag;")
                ...
                check_for_element(driver, 'h3[class="checked"]> a[class="seleccion-entradas-change change-step"]', click=True)
